...
# Pulled from this project: https://github.com/seanbechhofer/raspberrypi/blob/master/python/TSL2561.py
...
from common.adafruit.Adafruit_I2C.Adafruit_I2C import Adafruit_I2C
...
if __name__ == "__main__":
    tsl = TSL2561()
    print tsl.read_lux()
    print "LUX HIGH GAIN ", tsl.read_lux(16)
    print "LUX LOW GAIN ", tsl.read_lux(1)
    print "LUX AUTO GAIN ", tsl.read_lux()
