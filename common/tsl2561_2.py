...
# Thanks to janheise for working on this code.  Original here: https://github.com/janheise/TSL2561/blob/master/TSL2561.py
# This is just another attempt to get the TSL2561 working.
