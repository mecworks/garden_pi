...
ON = GPIO.LOW
OFF = GPIO.HIGH
zone_1_gpio = conf_parser.getint('zone_1', 'relay_gpio')
zone_2_gpio = conf_parser.getint('zone_2', 'relay_gpio')
zone_3_gpio = conf_parser.getint('zone_3', 'relay_gpio')
zone_4_gpio = conf_parser.getint('zone_4', 'relay_gpio')
for zone_gpio in [zone_1_gpio, zone_2_gpio, zone_3_gpio, zone_4_gpio]:
    GPIO.setup(zone_gpio, GPIO.OUT)
    GPIO.output(zone_gpio, OFF)
z1_watering_duration = conf_parser.getint('zone_1', 'watering_duration')
z2_watering_duration = conf_parser.getint('zone_2', 'watering_duration')
z3_watering_duration = conf_parser.getint('zone_3', 'watering_duration')
z4_watering_duration = conf_parser.getint('zone_4', 'watering_duration')
...
# time.sleep(30)
print("Watering zone_1 for %s seconds." % z1_watering_duration)
water_zone(zone_1_gpio, z1_watering_duration)
print("Watering zone_2 for %s seconds." % z2_watering_duration)
water_zone(zone_2_gpio, z2_watering_duration)
print("Watering zone_3 for %s seconds." % z3_watering_duration)
water_zone(zone_3_gpio, z3_watering_duration)
print("Watering zone_4 for %s seconds." % z4_watering_duration)
